			...
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<form method="POST" action="uploadProduct.php" enctype="multipart/form-data">
						<h2>Enter the Dish specifications here..!!</h2>
						<br>
				<center>
					  ...
					  <div class="col-sm-6">
						  <div class="select-wrapper" style="width: auto" >
							  <select name="type" id="type" required style="background-color:white;color: black;">
								  <option value="" style="color: black;">- Cuisine -</option>
								  <option value="Fruit" style="color: black;">Chinese</option>
								  <option value="Vegetable" style="color: black;">Italian</option>
								  <option value="Grains" style="color: black;">Indian</option>
							  </select>
						</div>
					  </div>
					  <div class="col-sm-6">
