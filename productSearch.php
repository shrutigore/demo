					...
					<form method="post" action="#">
						<div class="row uniform 50%">
							...
							<div class="12u 12u$(small)">
								 <h2 style="font-size: 120%;">Search by your cravings-</h2>
							</div>
							<div class="12u 12u$(small)">
								 <br>
								</div>
							...
							<div class="4u 12u$(small)">
										...
										<label for="priority-low"><h2 style="font-size: 120%;">American</h2></label>
									</div>
									<div class="4u 12u$(small)">
										<input type="radio" id="priority-normal" name="priority">
										<label for="priority-normal"><h2 style="font-size: 120%;">Chinese</h2></label>
									</div>
									<div class="4u$ 12u$(small)">
										<input type="radio" id="priority-high" name="priority">
										<label for="priority-high"><h2 style="font-size: 120%;"> Italian</h2></label>
									</div>
