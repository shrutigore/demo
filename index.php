	...
	?>
		...
		<!-- Banner -->
			<section id="banner" class="wrapper">
				<div class="container">
				<h2>Bon Appetit</h2>
				<p>Authentic taste of world cuisines...</p>
				<br><br>
				<center>
		...
		<!-- One -->
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<header>
						<h2>Bon Appetit</h2>
						<p>Authentic tastes of world cuisines!...</p>
					</header>
					<div class="row 200%">
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">Bon Appetit &copy; </h3>
		<!--	<div class="logo">
				<a href="index.php"><img src="images/logo.png" width="200px"></a>
			</div>-->
			<br />
			<p style="font-size:20px;color:white">Authentic taste of world cuisines !!!</p>
			<br />
		</div>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Bon Appetit Fam<span>Pune</span></p>
			</div>
			<div>
		...
		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About Bon Appetit</b></span>
				Bon Appetit is a five star michelin restaurant since 1988...
			</p>
								...
								<div class="row uniform 50%">
									...
									<div class="row uniform">
				                        ...
				                        <div class="3u 12u$(small)">
				                            ...
				                            <label for="farmer">Chef</label>
				                        </div>
				                        <div class="3u 12u$(small)">
				                            <input type="radio" id="buyer" name="category" value="1" checked >
