...
<body>
						...
						<div class="container">
							<div class="row">
								...
								<div class="col-12 col-sm-6">
									...
									<p style="font: 30px Times new roman;">Brought to you by Chef : <?= $frow['fname']; ?></p>
						...
						<div class="12u$">
                            <center>
                                <div class="row uniform">
                                    ...
                                    <div class="6u 12u$(large)">
                                        <a href="buyNow.php?pid=<?= $pid; ?>" class="btn btn-primary" style="text-decoration: none;">Order Now</a>
                                    </div>
                                </div>
                            </center>
                        </div>
			...
			?>
			<div class="container">
				<p style="font: 20px Times new roman; align: left;">Rate this Dish</p>
